...
melcanz.browserDescription[0] = "for BOTz Whatsapp"
...
console.log(color(figlet.textSync('FarrellDEV', {
		font: 'Standard',
...
console.log(color('[ Created by FarrellAR ]'))
melcanz.on('qr', async () => {
console.log('Scan Code QR ini untuk Menjalankan BOTz')
})
